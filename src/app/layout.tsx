...
  // *За custom meta тагове, които не са директно поддържани от Metadata типа, може да се наложи:*
  // other: {
...
      )}
    >
      {/* Няма <head> таг тук! Next.js го генерира сам. */}

      <body className="page-background flex flex-col items-center min-h-screen">
        {/* Schema.org JSON-LD и други скриптове се добавят чрез <Script> компонента */}
        <Script
