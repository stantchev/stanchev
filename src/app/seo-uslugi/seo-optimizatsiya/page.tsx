  ...
  if (!service) {
    return {
      ...
      description: 'SEO оптимизация за вашия бизнес! Подобрете класирането си в Google, увеличете трафика и осигурете устойчив растеж с нашите експертни SEO услуги.',
	    keywords: 'seo оптимизация цени, seo услуги, seo фирма, seo агенция, фирми за seo, seo услуги цени, оптимизация на сайтове, seo компания, услуги seo цена, добра seo фирма, seo оптимизация, как се прави ефективна seo оптимизация за онлайн магазин, цени за seo оптимизация на сайт за малък бизнес, добър seo консултант за оптимизация на уеб сайт',
	    alternates: {
