      ...
      <AccordionGroup
        items={[
          ...
          },
          {
            ...
            content: (
              <Text onBackground="neutral-weak">
                Съчетавам традиционното SEO с нетрадиционен AI подход и при нужда за корпоративни клиенти автоматизирам ключови процеси за мащабируемост и ефективност. С фокус върху CWV, crawl ефективност и съдържание, което определено изпъква.
              </Text>
            )
          },
          {
