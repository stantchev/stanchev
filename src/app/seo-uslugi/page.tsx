...
export default function SeoUslugi() {
  return (
              ...
              },
              {
                ...
                "mainEntity": [
                  ...
                  },
                  {
                    ...
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Станчев SEO се отличава с персонализиран подход към всеки клиент и прозрачност в работата. Ние задълбочено разбираме вашите бизнес цели и адаптираме стратегията си."
                    }
                  },
                  {
                    "@type": "Question",
                    ...
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Нашите SEO оптимизации са подходящи за фирмени сайтове, онлайн магазини и B2B проекти. Приоритетът е устойчив растеж на органичните приходи."
                    }
                  }
                ]
              }
    ...
    <Column maxWidth="l" gap="xl">
      ...
      <Grid columns="2" mobileColumns="1" gap="l" paddingX="l" className="items-stretch">
        ...
        items={[
          {
            ...
            content: (
              <Text onBackground="neutral-weak">
                Станчев SEO предлага цялостни SEO услуги: технически одит, on-page оптимизация, съдържание, линк билдинг и измерване на резултатите.
              </Text>
            )
          },
          {
            title: "С какво услугите на Станчев SEO се отличават?",
            content: (
              <Text onBackground="neutral-weak">
                Персонализиран подход, прозрачност и фокус върху устойчиви резултати. Използваме само етични white-hat практики.
              </Text>
            )
          },
          {
            title: "За какъв тип бизнес са подходящи?",
            content: (
              <Text onBackground="neutral-weak">
                Подходящи са за фирмени сайтове, онлайн магазини и B2B. Приоритетът е устойчив растеж на органичния трафик.
              </Text>
            )
          }
        ]}
