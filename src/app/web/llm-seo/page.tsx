    ...
    <>
      ...
      <Column as="section" gap="s" padding="l" maxWidth="m" horizontal="center" style={{ width: "100%", maxWidth: "100vw", overflow: "hidden" }}>
        ...
        <Column gap="l" align="center" paddingBottom="xl">
          <RevealFx speed="fast">
            <Column gap="m" align="center">
              ...
              >
                Генеративно SEO - Бъдещето на SEO е тук
              </Heading>
               <Text variant="display-default-s" align="center" onBackground="neutral-weak">
                ...
                <strong>Генеративно SEO</strong> Generative Engine Optimization (GEO)
        ...
        <Flex gap="8" wrap horizontal="center">
		  <Tag variant="brand">Generative Engine Optimization (GEO)</Tag>
        ...
        <Column gap="xl" align="center" paddingY="xl">
          <RevealFx>
            <Column gap="m" align="center">
              <Heading variant="display-strong-m" align="center">
                Generative Engine Optimization (GEO) услуги за бъдещето
              </Heading>
              <Text variant="body-default-xl" align="center" onBackground="neutral-weak">
                Специализирам се в <strong> генеративна оптимизация за големите езикови модели</strong> и 
        ...
        <Column gap="l" align="center" paddingY="l">
          <RevealFx>
            <Column gap="m" align="center">
              ...
              <Text variant="body-default-xl" align="center" onBackground="neutral-weak">
                Отговори на най-често задаваните въпроси за <strong>Генеративно SEO</strong>, 
          ...
          <RevealFx delay={0.1}>
            <AccordionGroup
              items={[
                {
                  title: "Какво е генеративно SEO и защо е важно?",
                  content: (
                    <Text onBackground="neutral-weak">
                      <strong>Генеративно SEO</strong> е оптимизация за големите езикови модели като ChatGPT, Gemini и Claude. 
                      Това е <strong>бъдещето на SEO</strong> - докато традиционното SEO се фокусира върху Google, 
                      генеративното SEO ви позиционира в AI системите за търсене, където потребителите отиват все повече. 
                ...
                },
                {
                  ...
                  content: (
                    <Text onBackground="neutral-weak">
                      AI системите използват различни алгоритми от Google. <strong>генеративно SEO</strong> оптимизацията 
                ...
                {
                  title: "Колко време отнема генеративна оптимизация?",
                  content: (
                    <Text onBackground="neutral-weak">
                      Първоначалната <strong>генеративна SEO</strong> оптимизация отнема 3-6 седмици, в зависимост от 
