...
export async function generateMetadata() {
  ...
  const ogImageUrl = `${baseURL}/images/nextjs-og-image.jpg`; // 1200×630 препоръчително
        ...
        <Column fillWidth style={{ maxWidth: '80rem', margin: '0 auto' }} gap="l">
            ...
            <Grid fillWidth columns={3} s={{ columns: 1 }} gap="l">
              ...
              >
                <Column fillWidth gap="m">
                  ...
                  <Button
                    ...
                    variant="primary"
                    href="/kontakti"
                    style={{ backgroundColor: primaryColor, marginTop: '1rem' }}
                  >
                    Избери пакет
                  </Button>
                </Column>
              ...
              >
                <Column fillWidth gap="m">
                  ...
                  <Flex gap="4" align="left">
                    <Text variant="display-strong-m" style={{ color: primaryColor }}>
                      По договаряне
                    </Text>
                  </Flex>
                  <Column fillWidth gap="4" paddingTop="m">
          ...
          >
            <Column fillWidth gap="l" align="center">
              ...
              <Text
                align="center"
                style={{ color: 'white', maxWidth: '48rem', margin: '0 auto' }}
              >
