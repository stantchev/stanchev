...
const AboutPage: React.FC = () => {
  ...
  return (
    <>
		...
		keywords="SEO специалист, SEO експерт България, Станчев, оптимизация за търсачки, SEO консултант, дигитален маркетинг, SEO София, техническо SEO, онлайн позициониране, органичен трафик"
		...
		structuredData={{
			...
			"description": "SEO специалист с опит в оптимизацията за търсачки, технически одит и изграждане на стратегии за дигитален успех в България.",
			"knowsAbout": [
				"SEO", 
				"Дигитален маркетинг", 
				"Анализ на данни", 
