...
const resources = {
  bg: {
    translation: {
      ...
      "about.description1": "Имам доказан опит в SEO оптимизацията, с който помагам на сайтове да заемат топ позиции в Google и да привличат повече органичен трафик. Работя с ефективни стратегии, които носят реални резултати и дългосрочен растеж. Целта ми е сайтът ви да бъде не само откриваем, но и предпочитан от потребителите.",
      "about.description2": "Специализирам в техническо SEO, оптимизация на съдържание и анализи, базирани на данни. Използвам модерни инструменти, за да следя и подобрявам всеки аспект от сайта. Подходът ми е гъвкав и винаги съобразен с последните тенденции и алгоритми.",
