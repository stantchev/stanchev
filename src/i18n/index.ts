...
const resources = {
  bg: {
    translation: {
      ...
      "about.description1": "С опит в SEO оптимизацията, позволяващ ми да постигам стабилни и устойчиви резултати за моите клиенти. Работя с доказани методи, които не само увеличават органичния трафик, но също така увеличават броя на посетителите на сайта. Моята цел е да издигна сайта ви на топ позиции в търсачките, като осигуря устойчиво нарастване на трафика в дългосрочен план.",
      "about.description2": "Специализация в техническо SEO, контент стратегия и оптимизация, базирана на данни. Използвам най-съвременните инструменти за SEO анализи, които ми позволяват да следя и оптимизирам всеки аспект от сайта. С данните и подробни анализи създавам стратегии, адаптиращи се към промените в алгоритмите на търсачките и тенденциите на пазара.",
      "about.description3": "Фокус върху измерими резултати чрез цялостни SEO решения и стратегически дигитален маркетинг. Всичките ми SEO кампании са подложени на стриктно проследяване, за да осигуря ясни и измерими резултати. Съчетавам техническа оптимизация с контент стратегия и линк билдинг, за да осигуря цялостно повишаване на авторитета на сайта.",
