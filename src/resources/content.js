  ...
  intro: {
    ...
    description: (
      <>
		...
		а алхимия от данни, логика и щипка въображение. 
		Създавам стратегии така, както диригент подрежда оркестър – 
		всеки инструмент влиза в точния момент. 
		SEO за мен е пътуване – не спринт, а маратон през непознати територии, 
		където AI е компасът, който намира най-прекия път. 
		Оптимизирам, автоматизирам и експериментирам всеки ден – 
		защото Google никога не заспива, а аз съм там, за да го настигна.
      </>
    ),
  },
  work: {
