...
const about: About = {
  ...
  intro: {
    ...
    description: (
      <>
      Аз съм SEO специалист и front-end разработчик, специализиран в
    ...
    experiences: [
      {
        ...
        achievements: [
        <>Използвах <strong>AI SEO алгоритми</strong> за автоматичен анализ и приоритизация на Core Web Vitals, подобрявайки скоростта на сайтове с над <strong>40%</strong>.</>,
        <>Чрез <strong>AI-базирана оптимизация на съдържание</strong> и прецизна<strong> GEO стратегия</strong> увеличих CTR с <strong>35%</strong> и органичния трафик с над <strong>200%</strong> за шест месеца.</>,
      <>Комбинирах <strong>локално SEO</strong>, <strong>AI-генерирани анализи</strong> и техническа оптимизация, за да изведа продуктови страници в топ резултатите при локални търсения.</>,
        ],
        images: [],
      },
      {
