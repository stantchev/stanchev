...
const about: About = {
  ...
  intro: {
    ...
    description: (
      <>
        Аз съм SEO & GEO специалист и front-end разработчик, специализиран в React, Next.js и Tailwind CSS. Комбинирам техническа прецизност и AI SEO подходи, за да създавам бързи, оптимизирани и видими сайтове.
        <br />
        <br />
        Фокусирам се върху GEO SEO стратегии, автоматизация и анализ чрез изкуствен интелект — постигането на устойчив растеж и висока конверсия е целта на всеки проект, който поемам.
        <br />
        <br />
