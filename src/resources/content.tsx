  ...
  intro: {
    ...
    description: (
      <>
        ...
        анализ чрез изкуствен интелект — постигането на <strong>устойчив растеж</strong>
        и <strong>висока конверсия</strong> е целта на всеки проект, който поемам.
        <br />
        <br />
        Вярвам, че перфектното SEO е балансирано между код, съдържание и UX —
        защото само така алгоритмите се превръщат в твой съюзник.
      </>
    ),
  },
  work: {
