...
const about: About = {
  ...
  (
    <>
      Използвах <strong>AI SEO алгоритми</strong> за автоматичен анализ и
      приоритизация на Core Web Vitals, подобрявайки скоростта на сайтове с над{" "}
      <strong>40%</strong>.
    </>
  ),
  (
    <>
      ...
      <strong>GEO стратегия</strong> увеличих CTR с <strong>35%</strong> и
      органичния трафик с над <strong>200%</strong> за шест месеца.
    </>
  ),
  (
    <>
      Комбинирах <strong>локално SEO</strong>,{" "}
      <strong>AI-генерирани анализи</strong> и техническа оптимизация, за да
      изведа продуктови страници в топ резултатите при локални търсения.
    </>
  ),
],
        images: [],
